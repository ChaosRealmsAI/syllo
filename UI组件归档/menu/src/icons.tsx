// Icon components for drag toolbar menu items

export const TextIcon = () => (
  <svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M2 3a1 1 0 0 1 1-1h18a1 1 0 0 1 1 1v4a1 1 0 1 1-2 0V4h-7v16h3a1 1 0 1 1 0 2H8a1 1 0 1 1 0-2h3V4H4v3a1 1 0 1 1-2 0V3Z" fill="currentColor"/>
  </svg>
);
...
export const DividerIcon = () => (
  <svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M9.5 4a1 1 0 0 1 1-1h3a1 1 0 1 1 0 2h-3a1 1 0 0 1-1-1Zm0 16a1 1 0 0 1 1-1h3a1 1 0 1 1 0 2h-3a1 1 0 0 1-1-1ZM3 11a1 1 0 1 0 0 2h18a1 1 0 1 0 0-2H3Zm14-7a1 1 0 0 1 1-1h3a1 1 0 1 1 0 2h-3a1 1 0 0 1-1-1Zm1 15a1 1 0 1 0 0 2h3a1 1 0 1 0 0-2h-3ZM2 4a1 1 0 0 1 1-1h3a1 1 0 0 1 0 2H3a1 1 0 0 1-1-1Zm1 15a1 1 0 1 0 0 2h3a1 1 0 1 0 0-2H3Z" fill="currentColor"/>
  </svg>
);
...
export const ArrowRightIcon = () => (
  <svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M7.293 4.293a1 1 0 0 0 0 1.414L13.586 12l-6.293 6.293a1 1 0 1 0 1.414 1.414l7-7a1 1 0 0 0 0-1.414l-7-7a1 1 0 0 0-1.414 0Z" fill="currentColor"/>
  </svg>
);
...
export const SyncedBlockIcon = () => (
  <svg width="1em" height="1em" viewBox="0 0 24 24" fill="none">
    <defs>
      <linearGradient id="synced-gradient" x1="0%" y1="0%" x2="50%" y2="100%">
        <stop offset="0%" stopColor="#336DF4"/>
        <stop offset="50%" stopColor="#5B65F5"/>
        <stop offset="100%" stopColor="#8F959E"/>
      </linearGradient>
    </defs>
    <path d="M14 5H3v8h3v2H3a2 2 0 01-2-2V5a2 2 0 012-2h11a2 2 0 012 2v8a2 2 0 01-2 2h-2v-2h2V5zm-4 4h2v2h-2v8h11v-8h-3V9h3a2 2 0 012 2v8a2 2 0 01-2 2H10a2 2 0 01-2-2v-8a2 2 0 012-2z" fill="url(#synced-gradient)"/>
  </svg>
);

export const ChildDocIcon = () => (
  <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
    <path d="M14.25 2.25H3.75v13.5H7.5v1.5H3.75a1.5 1.5 0 01-1.5-1.5V2.25a1.5 1.5 0 011.5-1.5h10.5a1.5 1.5 0 011.5 1.5v6h-1.5v-6z" fill="currentColor"/>
    <path d="M5.25 5.813a.75.75 0 01.75-.75h6a.75.75 0 010 1.5H6a.75.75 0 01-.75-.75zM6 8.813a.75.75 0 000 1.5h6a.75.75 0 000-1.5H6zM14.25 11.25a.75.75 0 00-1.5 0v2.25H10.5a.75.75 0 000 1.5h2.25v2.25a.75.75 0 001.5 0V15h2.25a.75.75 0 000-1.5h-2.25v-2.25z" fill="currentColor"/>
  </svg>
);